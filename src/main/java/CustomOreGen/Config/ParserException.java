...
public class ParserException extends SAXException {
    ...
    public String getMessage() {
        ...
        return this.node == null
            ? (this.lineNumber < 0 ? prefix + ": " + super.getMessage()
                : prefix + " at [line " + this.lineNumber + "]: " + super.getMessage())
            : (this.lineNumber < 0 ? prefix + " at " + formatNode(this.node, 16) + ": " + super.getMessage()
                : prefix + " at "
                    + formatNode(this.node, 0)
                    + " [line "
                    + this.lineNumber
                    + "]: "
                    + super.getMessage());
