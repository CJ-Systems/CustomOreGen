...
public class CustomOreGenBase {
    ...
    private static void unpackConfigs() {
        ...
        String[] extraModules = new String[] { "AppliedEnergistics.xml", "ArsMagica2.xml", "BiomesOPlenty.xml",
            "Chisel2.xml", "CommonOres.xml", "DenseOres.xml", "ElectriCraft.xml", "EtFuturum.xml", "Factorization.xml",
            "FlaxbeardsSteamcraft.xml", "Forestry.xml", "FossilsandArchaeology.xml", "Galacticraft.xml",
            "GeoStrata.xml", "Gregtech.xml", "Gregtech6.xml", "ImmersiveEngineering.xml", "MagnetiCraft.xml",
            "Mariculture.xml", "IndustrialCraft2.xml", "Mekanism.xml", "Metallurgy4.xml", "Mimicry.xml", "MineChem.xml",
            "MinecraftComesAlive.xml", "MinecraftSpecialRules.xml", "NetherOres.xml", "Netherrocks.xml",
            "Nuclearcraft.xml", "PamsHarvestCraft.xml", "ProjectRed.xml", "RailCraft.xml", "ReactorCraft.xml",
            "SimpleOres.xml", "Thaumcraft4.xml", "ThermalFoundation.xml", "TinkersConstruct.xml",
            "TinkersSteelworks.xml", "Vanilla.xml" };
    ...
    public static boolean unpackConfigFile(String configName, File destination) {
        ...
        try {
            InputStream ex = CustomOreGenBase.class.getClassLoader()
    ...
    public static boolean hasMystcraft() {
        if (_hasMystcraft == 0) {
            try {
                ...
                log.error(
                    "COG Mystcraft interface appears to be incompatible with the installed version of Mystcraft.",
                    var1);
            }
        }
