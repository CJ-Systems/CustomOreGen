...
public class ValidatorSimpleNode extends ValidatorNode {
    ...
    protected ValidatorSimpleNode(ValidatorNode parent, Node node, Class<? extends Object> targetClass,
    ...
    protected boolean validateChildren() throws ParserException {
        ...
        for (Node input = this.getNode()
            .getFirstChild(); input != null; input = input.getNextSibling()) {
