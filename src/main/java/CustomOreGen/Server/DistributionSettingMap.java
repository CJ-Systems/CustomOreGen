...
public class DistributionSettingMap {
    ...
    public void set(IOreDistribution dist, String settingName, Object value)
        ...
        if (dist != null) {
            ...
            if (entry == null) {
                throw new IllegalArgumentException(
                    "Setting \'" + settingName + "\' is not supported by distribution \'" + dist + "\'");
            } else {
                Field field = (Field) entry[0];
                ...
                if (Modifier.isFinal(field.getModifiers())) {
                    try {
                        ...
                        throw new IllegalArgumentException(
                            "Failed to copy setting \'" + annotation.name() + "\' for distribution \'" + dist + "\'",
                            var8);
                    }
                } else {
