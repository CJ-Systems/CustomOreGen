...
public class ValidatorBiomeDescriptor extends ValidatorNode {
    ...
    protected boolean validateChildren() throws ParserException {
        ...
        float minTemperature = this
            .validateNamedAttribute(Float.class, "MinTemperature", restriction.minTemperature, true);
        float maxTemperature = this
            .validateNamedAttribute(Float.class, "MaxTemperature", restriction.maxTemperature, true);
        ...
        int minTreesPerChunk = this
            .validateNamedAttribute(Integer.class, "MinTreesPerChunk", restriction.minTreesPerChunk, true);
        int maxTreesPerChunk = this
            .validateNamedAttribute(Integer.class, "MaxTreesPerChunk", restriction.maxTreesPerChunk, true);
        float minHeightVariation = this
            .validateNamedAttribute(Float.class, "MinHeightVariation", restriction.minHeightVariation, true);
        float maxHeightVariation = this
            .validateNamedAttribute(Float.class, "MaxHeightVariation", restriction.maxHeightVariation, true);
