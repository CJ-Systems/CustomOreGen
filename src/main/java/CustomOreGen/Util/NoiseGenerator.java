...
public class NoiseGenerator {
    ...
    private static Grad[] grad2 = new Grad[] { new Grad(1.0D, 0.0D, 0.0D), new Grad(-1.0D, 0.0D, 0.0D),
        new Grad(0.0D, 1.0D, 0.0D), new Grad(0.0D, -1.0D, 0.0D) };
    private static Grad[] grad3 = new Grad[] { new Grad(1.0D, 1.0D, 0.0D), new Grad(-1.0D, 1.0D, 0.0D),
        new Grad(1.0D, -1.0D, 0.0D), new Grad(-1.0D, -1.0D, 0.0D), new Grad(1.0D, 0.0D, 1.0D),
        new Grad(-1.0D, 0.0D, 1.0D), new Grad(1.0D, 0.0D, -1.0D), new Grad(-1.0D, 0.0D, -1.0D),
        new Grad(0.0D, 1.0D, 1.0D), new Grad(0.0D, -1.0D, 1.0D), new Grad(0.0D, 1.0D, -1.0D),
        new Grad(0.0D, -1.0D, -1.0D) };
    private static Grad[] grad4 = new Grad[] { new Grad(0.0D, 1.0D, 1.0D, 1.0D), new Grad(0.0D, 1.0D, 1.0D, -1.0D),
        new Grad(0.0D, 1.0D, -1.0D, 1.0D), new Grad(0.0D, 1.0D, -1.0D, -1.0D), new Grad(0.0D, -1.0D, 1.0D, 1.0D),
        new Grad(0.0D, -1.0D, 1.0D, -1.0D), new Grad(0.0D, -1.0D, -1.0D, 1.0D), new Grad(0.0D, -1.0D, -1.0D, -1.0D),
        new Grad(1.0D, 0.0D, 1.0D, 1.0D), new Grad(1.0D, 0.0D, 1.0D, -1.0D), new Grad(1.0D, 0.0D, -1.0D, 1.0D),
        new Grad(1.0D, 0.0D, -1.0D, -1.0D), new Grad(-1.0D, 0.0D, 1.0D, 1.0D), new Grad(-1.0D, 0.0D, 1.0D, -1.0D),
        new Grad(-1.0D, 0.0D, -1.0D, 1.0D), new Grad(-1.0D, 0.0D, -1.0D, -1.0D), new Grad(1.0D, 1.0D, 0.0D, 1.0D),
        new Grad(1.0D, 1.0D, 0.0D, -1.0D), new Grad(1.0D, -1.0D, 0.0D, 1.0D), new Grad(1.0D, -1.0D, 0.0D, -1.0D),
        new Grad(-1.0D, 1.0D, 0.0D, 1.0D), new Grad(-1.0D, 1.0D, 0.0D, -1.0D), new Grad(-1.0D, -1.0D, 0.0D, 1.0D),
        new Grad(-1.0D, -1.0D, 0.0D, -1.0D), new Grad(1.0D, 1.0D, 1.0D, 0.0D), new Grad(1.0D, 1.0D, -1.0D, 0.0D),
        new Grad(1.0D, -1.0D, 1.0D, 0.0D), new Grad(1.0D, -1.0D, -1.0D, 0.0D), new Grad(-1.0D, 1.0D, 1.0D, 0.0D),
        new Grad(-1.0D, 1.0D, -1.0D, 0.0D), new Grad(-1.0D, -1.0D, 1.0D, 0.0D), new Grad(-1.0D, -1.0D, -1.0D, 0.0D) };
    private final byte[] permutation = new byte[] { (byte) 17, (byte) 1, (byte) 31, (byte) 92, (byte) 22, (byte) 53,
        (byte) 127, (byte) 38, (byte) 84, (byte) 62, (byte) 54, (byte) 21, (byte) 123, (byte) 111, (byte) 49, (byte) 96,
        (byte) 95, (byte) 58, (byte) 104, (byte) 42, (byte) 34, (byte) 55, (byte) 78, (byte) 107, (byte) 105, (byte) 98,
        (byte) 39, (byte) 50, (byte) 125, (byte) 2, (byte) 91, (byte) 23, (byte) 119, (byte) 100, (byte) 70, (byte) 56,
        (byte) 3, (byte) 88, (byte) 66, (byte) 101, (byte) 29, (byte) 8, (byte) 43, (byte) 76, (byte) 124, (byte) 0,
        (byte) 15, (byte) 115, (byte) 83, (byte) 5, (byte) 19, (byte) 64, (byte) 106, (byte) 80, (byte) 48, (byte) 82,
        (byte) 121, (byte) 69, (byte) 117, (byte) 10, (byte) 61, (byte) 9, (byte) 109, (byte) 87, (byte) 94, (byte) 25,
        (byte) 20, (byte) 27, (byte) 102, (byte) 122, (byte) 60, (byte) 6, (byte) 33, (byte) 77, (byte) 89, (byte) 90,
        (byte) 118, (byte) 110, (byte) 75, (byte) 71, (byte) 113, (byte) 126, (byte) 67, (byte) 52, (byte) 74,
        (byte) 116, (byte) 44, (byte) 103, (byte) 14, (byte) 18, (byte) 93, (byte) 85, (byte) 108, (byte) 12, (byte) 32,
        (byte) 45, (byte) 47, (byte) 79, (byte) 68, (byte) 86, (byte) 24, (byte) 114, (byte) 30, (byte) 57, (byte) 59,
        (byte) 81, (byte) 4, (byte) 26, (byte) 36, (byte) 37, (byte) 120, (byte) 35, (byte) 65, (byte) 28, (byte) 7,
        (byte) 63, (byte) 40, (byte) 72, (byte) 73, (byte) 41, (byte) 99, (byte) 16, (byte) 97, (byte) 13, (byte) 112,
        (byte) 51, (byte) 11, (byte) 46 };
